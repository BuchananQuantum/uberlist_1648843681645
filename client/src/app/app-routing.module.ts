...
import { SeekerListComponent} from './pages/seeker-list/seeker-list.component';
...
const routes: Routes = [
    ...
    { path: 'seekers',  loadChildren: './pages/seeker-list/seeker-list.module#SeekerListModule' , canActivate: [AuthGuard] },
